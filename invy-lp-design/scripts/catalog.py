...
BLOCKS = {
  ...
  'invite-form': dict(label='紹介フォーム', cat='アクション', page='inviter', cms=['invite-form'],
    fields=[('eyebrow', '見出しラベル（英字）', 'text'), ('title', '見出し', 'multi'), ('f1', '項目1', 'text'), ('f2', '項目2', 'text'), ('f3', 'メッセージ欄の見出し', 'text'),
            ('msg', '初期メッセージ（送信文テンプレート）', 'multi'),
            ('privacy', '個人情報についての説明', 'multi'), ('methodTitle', '紹介方法の見出し', 'text'),
            ('cta', 'LINEボタン文言', 'text'), ('mailCta', 'メールボタン文言', 'text'), ('mailNote', 'メールボタン下の注記', 'multi'),
            ('snsLead', 'リンクシェアの前の見出し', 'multi'), ('linkCta', 'リンクボタン文言', 'text')],
    data={'title': 'クーポンを送ろう', 'f1': 'あなたのお名前', 'f2': 'あなたのメールアドレス', 'f3': 'お相手へのメッセージ',
          'msg': '紹介するとふたりとも特典がもらえるキャンペーン中だよ。よかったら使ってね。',
          'privacy': '個人情報の取扱いについてはプライバシーポリシーをご覧ください。', 'methodTitle': '紹介方法選択',
          'cta': 'LINEで友達に送る', 'mailCta': 'メールで送る',
          'mailNote': '※ご利用の環境によっては、メールソフトが自動で起動しない場合がございます。',
          'snsLead': 'SNSで複数人に\nシェアするならこちら', 'linkCta': 'リンクでシェア'}),
  ...
  'footer': dict(label='フッター（規約リンク）', cat='規約・フッター', page='both', cms=['footer'],
    fields=[('a', 'リンク1', 'text'), ('b', 'リンク2', 'text'), ('copyright', 'コピーライト表記', 'text')],
    data={'a': '利用規約', 'b': 'プライバシーポリシー', 'copyright': 'Copyright © 2026 INVY All Rights Reserved.'}),
